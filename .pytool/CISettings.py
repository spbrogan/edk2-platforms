...
class Settings(CiBuildSettingsManager, UpdateSettingsManager, CiSetupSettingsManager, PrEvalSettingsManager):
        ...
        return [
            {
                ...
                "Commit": "f80f052277c88a67c55e107b550f504eeea947d3"  # edk2-stable202302
            }
        ]
    ...
    def GetPackagesPath(self):
        ...
        result.append(os.path.join("Features"))
        result.append(os.path.join("Features", "Intel", "Debugging"))
        return result
